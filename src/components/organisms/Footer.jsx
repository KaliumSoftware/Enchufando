      ...
      <div className="w-full max-w-screen-2xl mx-auto p-4 md:py-14">
        <div className="sm:flex sm:items-center sm:justify-between">
          <a href="https://flowbite.com/" className="flex items-center mb-4 sm:mb-0">
            <span className="self-center  text-4xl font-semibold whitespace-nowrap dark:text-white">Enchufando</span>
          </a>
        ...
        <span className="block text-sm  sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Kalium Software</a>. Todos los derechos reservados.</span>
      </div>
    </footer>
