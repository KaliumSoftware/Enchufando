...
function ShoppingCart() {
    ...
    return (
        <>
            ...
            {show && (
                <div className="fixed w-screen h-screen bg-black bg-opacity-50 top-0 overflow-y-auto overflow-x-hidden left-0" id="chec-div">
                    <div className="w-full absolute z-10 left-0 h-full overflow-x-hidden transform translate-x-0  duration-700" id="checkout">
