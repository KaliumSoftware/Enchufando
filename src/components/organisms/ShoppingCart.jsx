          ...
          >
            ...
            >
              <div
                ...
                onClick={() => setShow(!show)}
              >
                <button class="group flex items-center justify-center space-x-2 text-white bg-black border border-gray-800 hover:bg-primary hover:border-blue-800 rounded-lg px-5 py-1 text-center mr-2 mb-2 transform origin-right scale-x-90 hover:scale-x-100 transition-transform ">
                  <svg class="h-4 w-4 mr-1 transform scale-0 group-hover:scale-125 transition-transform"
